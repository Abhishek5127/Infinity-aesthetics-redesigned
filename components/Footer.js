...
export default function Footer() {
  const mapUrl = "https://www.google.com/maps/search/?api=1&query=Infinity+Aesthetics-+Skin,+Laser+%26+Hair+Clinic&query_place_id=ChIJ2yUZNu_nuzkR3kUmvPRirXU";
  const mapEmbedUrl = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3571.8660282050882!2d74.63414207520799!3d26.46004707691985!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396be7ef361925eb%3A0x75ad62f4bc2645de!2sInfinity%20Aesthetics-%20Skin%2C%20Laser%20%26%20Hair%20Clinic!5e0!3m2!1sen!2sin!4v1783759882721!5m2!1sen!2sin";
        ...
        <div className="ia-footer-grid">
          <div>
            ...
            <div className="ia-footer-socials">
              ...
              <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="ia-footer-social" aria-label="Google Business">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg>
              </a>
              <a href="mailto:infinityaestheticsajmer@gmail.com" className="ia-footer-social" aria-label="Email">
          ...
          <div className="ia-footer-navs-wrapper">
            ...
            <div>
              ...
              <div className="ia-footer-links">
                ...
                <Link href="/services/hair-prp">PRP Hair Treatment</Link>
                <Link href="/services/acne-treatment">Acne Treatment</Link>
                <Link href="/services/pigmentation-treatment">Pigmentation Care</Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="ia-footer-links">
                {areasServed.slice(0, 8).map((area) => (
                  <Link href="/contact#areas-we-serve" key={area}>{area}</Link>
                ))}
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="ia-footer-ci">
              ...
              <a href={mapUrl} target="_blank" rel="noopener noreferrer">
                48-49, Ajmer Tower, Kutchery Road,<br />Ajmer, Rajasthan 305001
              </a>
            </div>
            <div className="ia-footer-ci" style={{ alignItems: "flex-start" }}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ marginTop: "4px" }}><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" /></svg>
              <div>

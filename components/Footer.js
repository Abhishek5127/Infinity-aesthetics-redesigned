        ...
        <div className="ia-footer-grid">
          ...
          <div className="ia-footer-navs-wrapper">
            ...
            <div>
              ...
              <div className="ia-footer-links">
                <Link href="/services/hydra-facial">HydraFacial Ajmer</Link>
                <Link href="/services/pigmentation-correction">Pigmentation Treatment</Link>
                <Link href="/services/tattoo-removal">Laser Clinic Ajmer</Link>
                <Link href="/services/hair-prp-therapy">PRP Hair Treatment</Link>
